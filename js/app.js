/* ============================================================
   VOD Corp — app.js
   Navegación + tema + animaciones de entrada (stagger)
   ============================================================ */
...
/* ── Animaciones de entrada al mostrar pantalla ─────────────────
   Replica list-animation.tsx: fade-up con stagger por índice
────────────────────────────────────────────────────────────────── */
function animateScreen(screen) {
  ...
  // Stats / cards → stagger fade-up
  const staggerTargets = screen.querySelectorAll(
    '.card, [class*="grid"] > div, .table-wrap tr'
  );
...
function show(id) {
  ...
  // Inyectar iconos en la pantalla recién activada
  injectIcons(screen);
